...
from models import db, QuizAttempt, Quiz, Staff, User,Topic,Lesson, Question,  Student, Course,Rs_student_course_enrol
...
from services.core.dao.RsStudentCourseEnrolDAO import rsStudentCourseEnrolCreate,rsStudentCourseEnrolRead
...
class Test_RsStudentCourseEnrolDAO(unittest.TestCase):
    ...
    def test_rsStudentCourseEnrolRead(self):
        self.assertTrue(rsStudentCourseEnrolRead(student_id=1,course_index='cz3003'))
